...
describe('Medici', function() {
  ...
  it('Should have updated the balance for assets and income and accurately give balance for subaccounts', function(
    done
  ) {
  ...
  describe('approved/pending transactions', function() {
    ...
    it('should set all transactions to approved when approving the journal', function(
      done
    ) {
      const book = new medici.book('MyBook');
